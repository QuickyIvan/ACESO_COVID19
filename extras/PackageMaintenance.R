...
OhdsiRTools::checkUsagePackage("ACESOCovid19")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/ACESOCovid19.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ACESOCovid19.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "ACESOCovid19",
                                mode = "description",
