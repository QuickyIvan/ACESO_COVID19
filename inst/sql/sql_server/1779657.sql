...
WHERE C.observation_period_end_date >= DATEFROMPARTS(2019, 12, 1)
...
WHERE C.value_as_concept_id in (45884084,45879438,45877985,4181412,4126681,9191,4214712,4216167,45878745,4328749,45876384)
