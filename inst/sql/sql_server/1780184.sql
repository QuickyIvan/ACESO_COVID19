...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4219484,440925,444362,4092411,4181216,439235,435446,4303690)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4219484,440925,444362,4092411,4181216,439235,435446,4303690)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (2796056,440069,4279309,37116660,440787,443274,37116661,4217840,44786481,434697,4302387,44790195,4149607,4219382,4269905,44787894,4004672,4151569,4319165)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2796056,440069,4279309,37116660,440787,443274,37116661,4217840,44786481,434697,4302387,44790195,4149607,4219382,4269905,44787894,4004672,4151569,4319165)
  and c.invalid_reason is null
...
WHERE C.condition_start_date >= DATEFROMPARTS(2018, 12, 1)
...
WHERE C.observation_date >= DATEFROMPARTS(2018, 12, 1)
...
WHERE C.procedure_date >= DATEFROMPARTS(2018, 12, 1)
