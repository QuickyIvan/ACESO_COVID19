...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (9201,32037,38004446,262,9203,4057410,3656370,45763734,4046295)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (9201,32037,38004446,262,9203,4057410,3656370,45763734,4046295)
...
WHERE C.visit_start_date >= DATEFROMPARTS(2018, 12, 1)
