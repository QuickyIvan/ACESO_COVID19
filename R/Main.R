...
#'
#' @details
#' This function executes the ACESOCovid19 Study.
#' 
...
execute <- function(connectionDetails,
  ...
  if (createCohorts) {
    ...
    message("Mapping target and comparator cohorts")
    cohortMapping(connectionDetails = connectionDetails,
                  cdmDatabaseSchema = cdmDatabaseSchema,
                  cohortDatabaseSchema = cohortDatabaseSchema,
  ...
  if(createSubgroups){
    message("Creating subgroup cohorts")
    CreateSubgroups(connectionDetails = connectionDetails,
                    cdmDatabaseSchema = cdmDatabaseSchema,
                    cohortDatabaseSchema = cohortDatabaseSchema,
                    cohortTable = cohortTable,
                    targetCohortId = targetCohortId,
  ...
  doPositiveControlSynthesis <- synthesizePositiveControls
