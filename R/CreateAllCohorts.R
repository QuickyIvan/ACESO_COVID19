...
createCohorts <- function(connectionDetails,
  ...
  cohortDefinitionSet <- CohortGenerator::getCohortDefinitionSet(packageName = "ACESOCovid19",
  ...
  write.csv(counts, file.path(outputFolder, "CohortCounts0.csv"), row.names = FALSE)
}
